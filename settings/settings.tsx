...
export const settings: Settings = {
    "Core": {
        ...
        checkVDEUpdates: {
            ...
            description: "When the app starts, check VendroidEnhanced updates and offer to install them",
            defaultValue: true
        },
        checkAnnouncements: {
            type: "toggle",
            label: "Check for announcements at start",
            description: "When the app starts, check for announcements from VendroidEnhanced maintainers",
            defaultValue: true
        },
        clientMod: {
            type: "select",
    ...
    "Other": {
        devSettings: {
            ...
            description: "These settings are only meant for developers to use and you will not get any support if things go wrong. Be careful.",
            type: "component",
            component: () => <>
                <Button color={Button.Colors.TRANSPARENT} onClick={showDevOptionsModal}>Open developer settings</Button>
            </>
        }
    }
};
